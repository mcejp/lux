...
UCODE_LUT = {
    ...
    OP_LDA | OMODE_S: (94, 7),
    OP_LDR: (101, 6),
    OP_LDR | OMODE_S: (107, 9),
    OP_LDZ: (116, 4),
    OP_LDZ | OMODE_S: (120, 7),
    OP_LIT & 31: (127, 3),
    OP_LIT & 31 | OMODE_S: (130, 5),
    OP_LTH: (135, 4),
    OP_LTH | OMODE_S: (139, 4),
    OP_MUL: (143, 4),
    OP_MUL | OMODE_S: (147, 4),
    OP_NEQ: (151, 4),
    OP_NEQ | OMODE_S: (155, 4),
    OP_NIP: (159, 3),
    OP_NIP | OMODE_S: (162, 3),
    OP_ORA: (165, 4),
    OP_ORA | OMODE_S: (169, 4),
    OP_OVR: (173, 5),
    OP_OVR | OMODE_S: (178, 5),
    OP_POP: (183, 1),
    OP_POP | OMODE_S: (184, 1),
    OP_ROT: (185, 6),
    OP_ROT | OMODE_S: (191, 6),
    OP_SFT: (197, 4),
    OP_SFT | OMODE_S: (201, 4),
    OP_STA: (205, 3),
    OP_STA | OMODE_S: (208, 4),
    OP_STH: (212, 2),
    OP_STH | OMODE_S: (214, 2),
    OP_STR: (216, 4),
    OP_STR | OMODE_S: (220, 6),
    OP_STZ: (226, 3),
    OP_STZ | OMODE_S: (229, 4),
    OP_SUB: (233, 4),
    OP_SUB | OMODE_S: (237, 4),
    OP_SWP: (241, 4),
    OP_SWP | OMODE_S: (245, 4),
    OP_ZZ_STKTRAP: (249, 9),
    OP_ZZ_UNIMPL: (258, 2),
}
